...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<guard-rspec>, ["~> 2.3.3"])
      s.add_development_dependency(%q<growl>, [">= 0"])
      s.add_development_dependency(%q<listen>, ["~> 0.7.0"])
      s.add_development_dependency(%q<sqlite3>, [">= 0"])
      s.add_development_dependency(%q<dalli>, [">= 0"])
      s.add_development_dependency(%q<redis>, ["~> 3.0.2"])
      s.add_development_dependency(%q<queencheck>, ["~> 1.0.0"])
    else
      ...
      s.add_dependency(%q<guard-rspec>, ["~> 2.3.3"])
      s.add_dependency(%q<growl>, [">= 0"])
      s.add_dependency(%q<listen>, ["~> 0.7.0"])
      s.add_dependency(%q<sqlite3>, [">= 0"])
      s.add_dependency(%q<dalli>, [">= 0"])
      s.add_dependency(%q<redis>, ["~> 3.0.2"])
      s.add_dependency(%q<queencheck>, ["~> 1.0.0"])
    end
  else
    s.add_dependency(%q<sequel>, ["~> 3.34"])
    s.add_dependency(%q<msgpack>, ["~> 0.5.1"])
